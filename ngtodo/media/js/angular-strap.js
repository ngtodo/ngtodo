  ...
  function ($timeout, $strapConfig) {
    ...
    var regexpMap = function regexpMap(language) {
      ...
      return {
        ...
        'mm': '(?:[0]?[1-9]|[1][012])',
        'm': '(?:[0]?[1-9]|[1][012])',
        'DD': '(?:' + angular.element.fn.datepicker.dates[language].days.join('|') + ')',
        'D': '(?:' + angular.element.fn.datepicker.dates[language].daysShort.join('|') + ')',
        'MM': '(?:' + angular.element.fn.datepicker.dates[language].months.join('|') + ')',
        'M': '(?:' + angular.element.fn.datepicker.dates[language].monthsShort.join('|') + ')',
